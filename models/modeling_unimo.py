...
class NeuralPrior(nn.Module):
    ...
    def __init__(self, input_size):
        ...
        self.unet = nn.Sequential(
            ...
            nn.ConvTranspose2d(16, 3, 3, padding=1), nn.Sigmoid()  # Output is a normalized RGB patch
        )
...
class UnimoModel(nn.Module):
    ...
    def forward(
        ...
        if isinstance(vision_hidden_states, tuple):
            ...
            # print("vision hidden states = ",vision_hidden_states.size())
        ...
        # print("avg states = ",averaged_hidden_states.shape)
